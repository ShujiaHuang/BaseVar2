...
python create_pipeline.py -f human_reference.fa --ref_fai human_reference.fa.fai -c chr1 --delta 5000000 -t 24 -L input_bamfile.list -G pop_group.list -o output_chr1_directory/ > run_basevar.sh
